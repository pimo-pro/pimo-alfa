...
### 2. Drawer.ts
**Mudanças:**
- ✅ Posiões recalculadas para peças encostadas
...
**Nenhuma mudança necessária** - Abertura individual jáimplementada.

### 6. drawerGroupToLayerItems.ts
**Nenhuma mudança necessária** - Adapter apenas propaga valores do domínio.

### 7. BoxBuilder.ts
**Nenhuma mudança necessária** - Jáusa posições do domínio sem offsets extras.
...
- [ ] Todas as peças visóveis e encaixadas
...
- [Drawer.ts](src/core/drawers/Drawer.ts) - Posiões corrigidas
