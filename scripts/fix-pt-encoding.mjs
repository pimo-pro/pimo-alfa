/**
 * fix-pt-encoding.mjs � corre��o segura de U+FFFD / mojibake.
 * FROM/TO apenas com escapes \\u � o pr�prio ficheiro n�o cont�m acentos literais.
 * N�o processa src/industrial/** nem este script.
 */
...
// prefixes �teis / �nico / �rea (s� se FFFD no in�cio de palavra � cuidado)
add([F, "til"], "\u00FAtil");
add([F, "teis"], "\u00FAteis");
add([F, "nica"], "\u00FAnica");
add([F, "nico"], "\u00FAnico");
