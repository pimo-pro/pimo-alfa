/**
 * Modal de exporta├º├úo ÔÇö Gerar Arquivo.
 * Op├º├Áes: tipo (PDF, Excel), conte├║do (Lista Industrial, PDF T├®cnico, Ambos), m├®todo (Download, Email, WhatsApp).
 */
        ...
        <div className="modal-list" style={{ padding: "0 16px 16px" }}>
          <div className="modal-list-item" style={{ padding: "12px 0", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
            <div className="modal-list-info">
              ...
              <div style={metaStyle}>Selecione o formato de sa├¡da</div>
            </div>
          ...
          <div className="modal-list-item" style={{ padding: "12px 0", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
            <div className="modal-list-info">
              <div style={labelStyle}>Conte├║do</div>
          ...
          <div className="modal-list-item" style={{ padding: "12px 0" }}>
            <div className="modal-list-info">
              <div style={labelStyle}>M├®todo de sa├¡da</div>
