...
**Razão:** O fundo passa por baixo da traseira e — parafusado (marcenaria real).
...
**Total:** 3 × 94mm = 282mm de altura úútil (18mm de folgas) ✅
...
❌ Impossóvel gerar PDF técnico completo
❌ Impossóvel fabricar (peças faltando)
```
...
- ✅ Posiões calculadas pelo domínio (DrawerParametrics + Drawer)
...
| **PDF Técúnico** | Impossóvel ❌ | Funcional ✅ |
...
- [ ] Frente estáflush com o box (não afastada)
- [ ] Todas as 5 peças visóveis e encaixadas
...
- ✅ Proporões corretas (front - body = 12mm)
...
**Renderização 3D:**
- ✅ Todas as 5 peças renderizadas no Three.js
- ✅ Posiões calculadas pelo domínio
...
- [ ] Preview de montagem (instruões passo-a-passo)
