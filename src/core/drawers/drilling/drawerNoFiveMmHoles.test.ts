/**
 * Garante que peças da gaveta NUNCA recebem furos —5 / corrediça.
 * Corrediças = apenas laterais do módulo.
 */
...
describe("gaveta — sem furos —5 / corrediça (SSOT ? PDF ? XML)", () => {
  ...
  it("lat_esq — cutlistToPieces + holesForPdf só cavilhas (+ rasgo se presente)", () => {
    const result = buildPanelDrillingResult(
