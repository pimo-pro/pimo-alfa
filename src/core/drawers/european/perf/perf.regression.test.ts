/**
 * Regressão de desempenho: resultados industriais estáveis após memo/validateAll.
 */
...
describe("european/perf — regressão transparente", () => {
  ...
  it("generateEuropeanDrawer é estável entre duas chamadas (cache hit)", () => {
