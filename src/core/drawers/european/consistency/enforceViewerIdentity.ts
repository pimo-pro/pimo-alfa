/**
 * enforceViewerIdentity.ts — Identidade industrial no viewer data.
 ...
 * Geometria intacta; holes pieceRef normalizados; id de drawer estável.
 */
  ...
  return {
    drawers: viewer.drawers.map((d) => {
      ...
      return {
        ...d,
        holes,
        // id permanece eu-drawer-*; metadados de peça vivem nos holes pieceRef canúnicos
      };
    }),
  };
}
