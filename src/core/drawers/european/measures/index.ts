/**
 * measures/  Clculos de peas e folgas do Sistema Europeu (Modelo B).
 * Regras industriais: folga lateral 7 mm, corpo = corredia ? 10, Hettich.
 */
...
/** Profundidade do corpo sem frente = corredia ? 10 mm. */
...
/** Largura interna da caixa (mdulo) aps laterais de madeira. */
 ...
 * Mantm assinatura com model por compatibilidade; a folga industrial  fixa (7 mm).
 */
...
/** Profundidade do corpo sem frente = comprimento da corredia ? 10 mm. */
...
/**
 * Profundidade til interna para seleo da corredia.
 * Preferncia: valor explcito; seno P externa ? costa ? margem frontal tpica.
 */
...
/**
 * Seleciona corredia Hettich (strictly &lt; profundidade til interna).
 * Mantm assinatura legada; ignora depths do catlogo de marca.
 */
...
/** Seleo cannica Modelo B a partir da caixa. */
