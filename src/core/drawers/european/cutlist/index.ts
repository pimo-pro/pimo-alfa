 ...
 * Nomes/cdigos industriais + materiais/espessuras oficiais.
 */
...
function buildEuropeanCutlistItemsCore(params: {
  ...
  // Corpo (linha de grupo / referncia)
  ...
  items.push({
    ...
    observacoesIndustriais: `Corpo sem frente; corredia ${geometry.runnerDepthMm} mm; folga lateral 7+7`,
  });
  ...
  items.push({
    ...
    nome: `Par corredias Hettich ${geometry.runnerDepthMm} mm`,
...
/** Cutlist memoizado  transparente; material da frente faz parte da chave. */
