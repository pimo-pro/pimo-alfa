/**
 * P3 — Fachada IndustrialCenter (Opcao A: classic-first).
 *
 * Camada unica de acesso a:
 *   A) Dados SSOT (live ProjectState + cutlist canonica)
 *   B) Apresentacao PDF (resolve + classic presentation)
 *   C) Maquina (CNC/TCN/drill/nesting) — cutlist base + pieceEdits, SEM overrides documentais
 *
...
/**
 * Items UEE: cutlist + whitelist documental (material/qtd/obs/×).
