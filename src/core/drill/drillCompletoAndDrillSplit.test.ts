/**
 * drill/XML: *_COMPLETO.xml (todas) + *_DRILL.xml (sù estaùùo DRILL).
 */
...
describe("drill/XML ù COMPLETO + DRILL", () => {
  ...
  it("_DRILL sù tem peùas da estaùùo DRILL; _COMPLETO tem todas", () => {
    const items = [
  ...
  it("etiqueta DRILL sù para peùas da estaùùo DRILL (COMPLETO nùo conta)", () => {
