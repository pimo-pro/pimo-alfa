...
describe("orlaCalculator industrial", () => {
  it("costa = 0 m; gav_frent_int = topo; porta 4 lados", () => {
    const items = [
    ...
    // porta 2.632 m + gav_frent_int 0.5 m
    expect(ferragem.metrosTotal).toBeCloseTo(3.132, 3);
  });
  ...
  it("costa do modulo sem orla; gaveta_traseira só topo", () => {
    const items = [
      piece("c1", "costa", { largura: 600, altura: 720 }),
  ...
  it("remate extra: orla em todas as bordas", () => {
  ...
  it("sync com defaultPreset: cima e porta com orla", () => {
    const items = [
  ...
  it("prateleira recebe orla em todas as bordas", () => {
