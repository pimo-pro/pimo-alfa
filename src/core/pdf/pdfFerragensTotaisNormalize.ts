...
/** Ref industrial oficial da dobradiùa principal (PDF / totais). */
...
/**
 * Contagem oficial de dobradiùas para PDF/online (apresentacao).
 * Fonte: canecos ù35 (holeType === "dobradica") nas pecas porta do cutlist.
