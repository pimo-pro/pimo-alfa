...
- Compatével com todos os módulos da Kitchen Library
...
- Relatérios técnicos e industriais
...
- Compatével com regras industriais de montagem

### Kitchen Planner (modo cliente)
- Inseráão de gavetas nos módulos
- Medidas internas e aberturas visóveis
- Preço em tempo real
