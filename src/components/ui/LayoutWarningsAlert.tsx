...
const collisionItemStyle: React.CSSProperties = {
  padding: "6px 8px",
...
const outOfBoundsItemStyle: React.CSSProperties = {
  padding: "6px 8px",
...
function LayoutWarningsAlertComponent({ warnings, boxId }: Props) {
...
export default memo(LayoutWarningsAlertComponent);
