      ...
      {open && (
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <span style={{ fontSize: 11, color: "var(--text-muted)" }}>
            Aplicar as mesmas ferragens a todas as gavetas. Alteraùùes individuais mantùm prioridade atù voltar a aplicar o global.
          </span>

          <label style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            <span style={{ fontSize: 11, color: "var(--text-muted)" }}>Corrediùa</span>
            <select
          ...
          <label style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            <span style={{ fontSize: 11, color: "var(--text-muted)" }}>Caixa metùlica</span>
            <select
              className="select select-xs"
          ...
          {metalProfile && listMetalBoxProfilesForType(draft.metalBoxType).length > 1 && (
            <label style={{ display: "flex", flexDirection: "column", gap: 4 }}>
              <span style={{ fontSize: 11, color: "var(--text-muted)" }}>Perfil / sùrie</span>
              <select
                className="select select-xs"
          ...
          <label style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            <span style={{ fontSize: 11, color: "var(--text-muted)" }}>Profundidade padrùo (mm)</span>
            <select
              className="select select-xs"
