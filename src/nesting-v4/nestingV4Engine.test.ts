...
function makePiece(id: string, w: number, h: number, boxId = "box-1"): V4Piece {
  return {
    id,
    name: id,
    widthMm: w,
...
describe("runNestingV4AutoLayout (CutLayout industrial)", () => {
  it("coloca todas as peças pequenas numa chapa via runCutLayout", () => {
    ...
    const result = runNestingV4AutoLayout(pieces, sheets, settings);
