/**
 * Diagn�stico mat�ria da frente da gaveta � singleMaterial (paridade portas).
 */
...
describe("diagn�stico mat�ria frente gaveta", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it("imprime valores e confirma mat�ria �nica em toda a pe�a (sem cap)", async () => {
