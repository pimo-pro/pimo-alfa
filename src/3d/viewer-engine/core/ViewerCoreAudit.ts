...
export const VIEWER_CORE_AUDIT: ViewerCoreAuditItem[] = [
  ...
  },
  {
    id: "dual-wall-snap",
    severity: "medium",
    area: "SmartSnapping + TransformConstraints/ModelWallSnap",
    finding: "Dois sistemas de snap a parede durante translate.",
    recommendation: "Não unificar nesta passagem — alteraria comportamento.",
    touchedInPass: false,
  },
  {
    id: "overlay-zindex",
  ...
  },
  {
    ...
    finding: "Ordem: translate → SmartSnapping → TransformConstraints → overlays no frame seguinte.",
